    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a class="nav-link mt-3 mt-md-0 mx-md-2" href="?page=profile">
                <label for="profileImage"><?= $user['fname']; ?></label>
                <label for="profileImage"><?= $user['lname']; ?></label>
                <img src="img/user.png" alt="Profile image" id="profileImage" class="img-fluid ms-2" style="width: auto; height: 3rem;">
            </a>
